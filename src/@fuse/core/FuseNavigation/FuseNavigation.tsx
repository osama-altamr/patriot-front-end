...
import FuseNavVerticalSkeletonItem from "./vertical/types/FuseNavVerticalSkeletonItem";
...
registerComponent("vertical-skeleton-item", FuseNavVerticalSkeletonItem);
...
function FuseNavigation(props: FuseNavigationProps) {
  ...
  return (
    <>
      {inputGlobalStyles}
      {layout === "horizontal" && (
        <FuseNavHorizontalLayout1 checkPermission={false} {...props} />
      )}
      {layout === "vertical" && (
