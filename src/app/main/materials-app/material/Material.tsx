...
function Material() {
	...
	const schema = z.object({
		...
		height: optionalNumberValidation().or(optionalStringValidation()),
		width: optionalNumberValidation().or(optionalStringValidation()),
		quantity: optionalNumberValidation().or(optionalStringValidation()),
	...
	if (
		isLoading ||
		_.isEmpty(form) ||
		(material && routeParams.materialId !== material.id && routeParams.materialId !== 'new')
	) {
		return <FuseLoading />;
	}
