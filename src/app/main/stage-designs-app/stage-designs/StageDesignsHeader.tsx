...
function StageDesignsHeader() {
	...
	const dateFromFilter = useSelector(selectStageDesignsDateFromFilter);
	const dateToFilter = useSelector(selectStageDesignsDateToFilter);
			...
			<div className="flex flex-1 items-center justify-end space-x-8">
				...
				>
					<FilterIcon
						...
						changesCount={
							[
								!_.isEqual(dateFromFilter, stageDesignsInitialState.dateFromFilter),
								!_.isEqual(dateToFilter, stageDesignsInitialState.dateToFilter)
				...
				>
					...
					>
						...
						<Input
							placeholder={t('SEARCH_STAGE_DESIGNS')}
							...
							onChange={(ev) => {
								dispatch(setStageDesignsSearchText(ev));
							}}
						/>
					</Paper>
				</motion.div>
				{FuseUtils.hasOperationPermission(employeeScopes.stages, 'create', user) && (
					<motion.div
...
export default StageDesignsHeader;