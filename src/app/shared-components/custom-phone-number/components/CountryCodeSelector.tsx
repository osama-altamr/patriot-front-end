    ...
    return (
      <div ref={ref}>
        ...
        >
          ...
          />
          <span className="ms-8 font-medium">{country?.code}</span>
        </Button>
        <Menu
          id="country-menu"
          MenuListProps={{
        ...
        >
          {countries?.map((item) => (
            ...
            >
              ...
              />
              <span className="ms-8 font-medium">{item.code}</span>
            </MenuItem>
          ))}
        </Menu>
      </div>
